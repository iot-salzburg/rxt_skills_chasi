...
class VoiceOutput(object):
    ...
    _feedback = rxt_skills_chasi.msg.VoiceOutputFeedback() # create feedback message
    _result = rxt_skills_chasi.msg.VoiceOutputResult() # create result message

    def __init__(self, name):
        self._action_name = name
        self._as = actionlib.SimpleActionServer(self._action_name, rxt_skills_chasi.msg.VoiceOutputAction, execute_cb=self.execute_cb, auto_start = False)
        self._as.start()
    ...
    def execute_cb(self, goal):
        ...
        success = chasi_speak(goal.outputMessage)
