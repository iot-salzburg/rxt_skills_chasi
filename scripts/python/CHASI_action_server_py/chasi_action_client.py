...
if __name__ == '__main__':
	...
	# request SendMessage
        ...
        result = send_ROSActionRequest_WithGoal('SendMessage', rxt_skills_chasi.msg.SendMessageAction, rxt_skills_chasi.msg.SendMessageGoal(messageContent=b'START_LOADING'))
        if result:
	...
	# request OnMessageReceive
        ...
        result = send_ROSActionRequest_WithGoal('OnMessageReceive', rxt_skills_chasi.msg.OnMessageReceiveAction, rxt_skills_chasi.msg.OnMessageReceiveGoal(messageContent=b'START_LOADING'))
        if result:
            print("Result was: " + str(result.isOK))
        print ('----------------------------------')
