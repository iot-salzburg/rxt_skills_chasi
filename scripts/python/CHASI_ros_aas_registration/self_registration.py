...
def loadAASType():
    ...
    with open('/home/chasi/ros_workspace/src/rxt_skills_chasi/scripts/python/CHASI_ros_aas_registration/CHASI_type.json', 'r') as dt_file:
...
def loadAASInstance():
    ...
    with open('/home/chasi/ros_workspace/src/rxt_skills_chasi/scripts/python/CHASI_ros_aas_registration/CHASI_instance.json', 'r') as dt_file:
        dt_data = json.load(dt_file) 
        # TODO
